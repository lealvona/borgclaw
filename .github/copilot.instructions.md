# GitHub Copilot Instructions - Universal Project Guidelines

> **About This File**: These are always-on instructions that apply to all chat requests in this workspace. For task-specific workflows, see [Agent Skills](skills/) which load on-demand.
...
1. **Read all project documentation:**
   ...
   - Check `.github/instructions/` for ticket-specific context
   - Review any project-specific guidelines

2. **Familiarize yourself with available skills:**
   - Review skill names and descriptions in `.github/skills/`
...
**Why This Matters:**
- Ensures you follow established patterns and conventions
- Prevents duplicate work or conflicting approaches
- Helps you use the right tools and skills for the task
- Maintains consistency across the codebase
- Avoids scope creep by understanding boundaries upfront
...
## Project-Specific Instructions Pattern

### File Structure
This universal instruction file (`copilot.instructions.md`) contains guidelines applicable to ANY project or codebase. For project-specific or ticket-specific context, use the following pattern:

**Structure:**
```
.github/
├── copilot.instructions.md          # Universal guidelines (this file)
└── instructions/
    ├── <ticket-id>.instructions.md  # Ticket-specific notes
    └── <project>.instructions.md    # Project-specific guidelines
```

### Creating Per-Ticket Instructions

**When to Create:**
- Working on a specific ticket/issue that requires context
- Complex multi-repository changes
- Custom workflows for specific features
- Temporary project-specific requirements
- Migration or refactoring work

**File Naming Convention:**
- Use lowercase ticket ID: `int-2614.instructions.md`, `proj-123.instructions.md`
- Store in: `.github/instructions/`
- One file per ticket/context

**Template for Per-Ticket Instructions:**
```markdown
...
### What to Include in Per-Ticket Instructions

**DO Include:**
- Specific repository URLs and configuration
- Actual usernames and organization names
- Concrete file paths and line numbers
- Links to PRs, tickets, and related work
- Technology stack for this project
- Team member contacts (if appropriate)
- Testing and deployment specifics
- Known issues or blockers
- Quick command references for this project
...
For general project guidelines (not ticket-specific), create:
- `.github/instructions/<project-name>.instructions.md`
...
- [ ] No merge conflicts
- [ ] Remote configuration verified (especially NO_PUSH)
...
Agent Skills are specialized capabilities stored in `.github/skills/` that load on-demand when relevant to your task. Unlike these always-on instructions, skills include:
...
The `.github/rules/` directory provides mid-execution agent control:
- **`immediate.md`** - Add directives here to redirect the agent during execution
- **`.stop`** - Create this file to disable directive checking temporarily
...
4. Skills work across VS Code, Copilot CLI, and coding agent

See [Agent Skills documentation](https://agentskills.io/) for the open standard specification.
